...
const EncryptionItem: React.FC<EncryptionItemProps> = ({ type }) => {
  ...
  return (
    <Link href={itemLink}>
      <a className='flex flex-1 p-4 flex-col items-center justify-center bg-indigo-500 dark:bg-indigo-400 dark:hover:bg-indigo-500 rounded-lg cursor-pointer hover:bg-indigo-600'>
        {iconSVG}
